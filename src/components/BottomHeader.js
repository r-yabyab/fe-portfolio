...
function BottomHeader () {
    ...
    return (
        <>
            ...
            <div className=" bg-neutral-300 flex justify-center pb-10 pt-10">
                <div></div>
                ...
                <a 
                    ...
                    <div className="flex items-center gap-4 [&>div>svg]:hover:text-blue-300 [&>div]:hover:text-white">
                        <div><svg className="text-[#0072b1] bg-white" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div className="-mt-[26px] w-[32px] h-[20px] bg-white" />
                        </div>
                        <div>cayabyabrr@yahoo.com</div>

                    </div>
                    <div className="flex gap-4 items-center -mt-[30px] ml-[240px]">
                        <p className="absolute ml-8 ">{copied ? "Copied to clipboard" : null}</p>
